...
(function(){
	...
	SelectParser=function(){
		...
		SelectParser.prototype.add_group=function(group){
			...
			this.parsed.push({array_index:group_position, group:!0, label:group.label, children:0, disabled:group.disabled}), 
		...
		SelectParser.prototype.add_option=function(option, group_position, group_disabled){
			if(option.nodeName.toUpperCase()==="OPTION")
				return option.text!==""?(group_position!=null&&(this.parsed[group_position].children+=1), 
						this.parsed.push({
							array_index:this.parsed.length, 
							options_index:this.options_index, 
							value:option.value, 
							text:option.text, html:option.innerHTML, 
			...
			array_index:this.parsed.length, 
			options_index:this.options_index, empty:!0}), 
...
SelectParser.select_to_array=function(select){
		...
		for(_i=0, _len=_ref.length; _i<_len; _i++)
			child=_ref[_i], parser.add_node(child); return parser.parsed
	}, this.SelectParser=SelectParser}).call(this), 
function(){
		...
		function AbstractChosen(form_field, options){
			...
			return this.click_test_action=function(evt){
				...
				this.allow_single_deselect=this.options.allow_single_deselect!=null&&
					...
					this.form_field.options[0].text===""?this.options.allow_single_deselect:!1, 
