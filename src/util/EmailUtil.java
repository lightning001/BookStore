...
public class EmailUtil {
	static final String fromEmail = "itnonglam84@gmail.com"; // requires valid
																// gmail id
	static final String password = "itnonglam"; // correct password for gmail
												// id
	...
	public static Session getSession() {
		...
		props.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory"); // SSL
																						// Factory
		props.put("mail.debug", "true"); // Class
