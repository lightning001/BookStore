...
<meta name="description"
	content="Đọc truyện online hay và mới nhất. Các thể loại: Truyện kiếm hiệp, tiên hiệp, sắc hiệp, đô thị, ngôn tình, truyện convert, truyện YY.">
<meta name="keywords"
...
<title>Đọc truyện online - Truyện Kiếm Hiệp, Tiên Hiệp, Sắc
	Hiệp, Truyện YY</title>
<link href="<%=request.getContextPath()%>/user/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/user/css/bootstrap-responsive.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/user/css/yamm.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/user/css/style.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/user/css/font-awesome.min.css"
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/user/css/chosen.css"
	rel="stylesheet">
<link rel="icon" type="image/png" href="img/favicon.png" />
<link href="https://plus.google.com/103281900225927837176/" rel="author">
<script src="<%=request.getContextPath()%>/user/js/jquery-1.12.4.js"></script>
<script src="<%=request.getContextPath()%>/user/js/chosen.jquery.js"></script>
<script src="<%=request.getContextPath()%>/user/js/bootstrap.min.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/user/js/csrf.js"></script>
<style>
body {
	padding-top: 60px;
	padding-bottom: 40px;
			...
			<div class="container">
				...
				<div class="nav-collapse">
					<ul class="nav">
						...
						<li><a href="index.html"><i class="fa fa-list-alt"
								aria-hidden="true"></i> Điều khoản</a></li>
						<li><a href="index.html"><i class="fa fa-phone"
				...
				<div class="row wrapper">
					<div class="span2 YY">
						<ul class="nav nav-list">
							<li class="YY"><a href="index.htm" tppabs=" ">Trang Chủ</a></li>
							...
							<ul class="thumbnails">
								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Đại Chúa Tể" width="160"
										height="210" src="img/72b3e7bd5ecb535c982bcdef49f29705.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Đại Chúa Tể</h2> <i class="icon-star-empty star"></i> <span
											class="label label-warning">Chương 1434</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Bất Hủ Phàm Nhân" width="160"
										height="210" src="img/c37702124653a3903857d0eb81434f6a.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Bất Hủ Phàm Nhân</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 575</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Toàn Chức Cao Thủ" width="160"
										height="210" src="img/460cce87dcbbe31843ae8396a9b8f24a.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Toàn Chức Cao Thủ</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 832</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Yêu Thần Ký" width="160"
										height="210" src="img/175ae0d8b6e3eeef1af359f817bfeb30.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Yêu Thần Ký</h2> <i class="icon-star-empty star"></i> <span
											class="label label-warning">Chương 448</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Đế Tôn" width="160" height="210"
										src="img/a0d1adeadd94ffa868c46ffe70da1f18.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Đế Tôn</h2> <i class="icon-star-empty star"></i> <span
											class="label label-warning">Chương 2802</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="La Phù" width="160" height="210"
										src="img/0334598de551016f3e129d6a39038040.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>La Phù</h2> <i class="icon-star-empty star"></i> <span
											class="label label-warning">Chương 795</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Tạo Hóa Chi Môn" width="160"
										height="210" src="img/b288eb342e5d7d38a883c560c38a3c7e.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Tạo Hóa Chi Môn</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 1535</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Cảnh Lộ Quan Đồ" width="160"
										height="210" src="img/9c107b4ae2dd53280ff6b94fd536ecff.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Cảnh Lộ Quan Đồ</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 1102</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Thiếu Gia Phong Lưu" width="160"
										height="210" src="img/250c3deb9cfb184e92fbf5cd8362d25b.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Thiếu Gia Phong Lưu</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 485</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Đỉnh Cấp Lưu Manh" width="160"
										height="210" src="img/f4c26ca4a9b7cc5dd8f5f8fb95ef263d.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Đỉnh Cấp Lưu Manh</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 1033</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Võ Đạo Đan Tôn" width="160"
										height="210" src="img/bd8cff5b36f43072fc4a7225323afb65.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Võ Đạo Đan Tôn</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 1339</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Thần Ma Thiên Tôn​" width="160"
										height="210" src="img/3dd703f6e11b7a8f4e37ae06cd1a5ad9.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Thần Ma Thiên Tôn ​</h2> <i class="icon-star-empty star">
										</i> <span class="label label-warning">Chương 1003</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Ma Thiên Ký" width="160"
										height="210" src="img/b5326673f4b51e461c93afe564c75fd7.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Ma Thiên Ký</h2> <i class="icon-star-empty star"></i> <span
											class="label label-warning">Chương 1737</span>
										</a>
									</div></li>

								<li class="span2"><a href="#" class="thumbnail"
									target="_blank"> <img alt="Thế Giới Tiên Hiệp" width="160"
										height="210" src="img/0656988c8f7fe08baf95e9c62b32ff31.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Thế Giới Tiên Hiệp</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 410</span>
										</a>
									</div></li>

								<li class="span2"><a href="#"
									tppabs=" truyen/chua-te-chi-vuong/" class="thumbnail"
									target="_blank"> <img alt="Chúa Tể Chi Vương" width="160"
										height="210" src="img/21e197588537eaccfeea118731277922.jpg">
								</a>
									<div class="caption">
										<a href="#" target="_blank">
											<h2>Chúa Tể Chi Vương</h2> <i class="icon-star-empty star"></i>
											<span class="label label-warning">Chương 1350</span>
										</a>
									</div></li>
							</ul>
						</div>
