			...
			<div class="container">
				<div class="row">
					<div class="span12 auth">
						...
						<div class="row">
							<div class="span9">
								<form action="<%=request.getContextPath()%>/login" method="post" role="form"><div style='display:none'><input type='hidden' name='csrfmiddlewaretoken' value='GBFs8dpdU4oMnI92HERYMd33OUWHunmM'/></div>
